    ...
    <main class="mdl-layout__content">
      ...
      <form action="answer.php" method="GET">
        ...
        <div class="mdl-textfield mdl-js-textfield">
          ...
          <label class="mdl-textfield__label" for="first-integer">Enter the first integer here...
          </label>
        ...
        <div class="mdl-textfield mdl-js-textfield">
          ...
          <input
            ...
            name="second-integer" />
          <!-- mdl-textfield__label -->
          <label class="mdl-textfield__label" for="second-integer">Enter the second integer here...
          </label>
          <!-- class "mdl-textfield__error" -->
          <span class="mdl-textfield__error">Input is not a valid number.</span>
        </div>
